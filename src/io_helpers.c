 ...
 */
size_t tokenize_input(__attribute__((unused))char *in_ptr, char **tokens) {
    // TODO: Remove unused attribute
   

    char *curr_ptr = strtok (in_ptr, DELIMITERS); // curr_ptr points to the first token
    size_t token_count = 0;


    // iterate through tokens and return number of tokens 
